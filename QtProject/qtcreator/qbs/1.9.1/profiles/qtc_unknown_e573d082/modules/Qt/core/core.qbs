...
Module {
    ...
    property path docPath: "/usr/local/Cellar/qt/5.12.2/doc"
    ...
    property string libFilePathRelease: "/usr/local/Cellar/qt/5.12.2/lib/QtCore.framework/QtCore"
    ...
    cpp.includePaths: {
        var paths = ["/usr/local/Cellar/qt/5.12.2/lib/QtCore.framework/Headers"];
